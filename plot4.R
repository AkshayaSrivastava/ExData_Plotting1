...
## TODO: Create plot 4 that matches instructor's plot 4
...
## extracting Global Reactive Power data and converting to numeric
data4<-dataset[,4]
global_reactive_power <- as.numeric(levels(data4))[data4]
global_reactive_power <- global_reactive_power[!is.na(global_reactive_power)]

## extracting Global Active Power data and converting to numeric
data5<-dataset[,5]
voltage <- as.numeric(levels(data5))[data5]
